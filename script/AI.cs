...
public class AI : MonoBehaviour
{
    ...
    bool fleeStatus;
    public Vector3 lastKnownPositionOfPlayer;
    ...
    //New tasks added to recover health and return to the last player position
    [Task]
    public void SetDestinationToLastKnownPositionOfPlayer()
    {
